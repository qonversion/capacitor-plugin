...
public class QonversionPlugin: CAPPlugin, CAPBridgedPlugin {
  ...
  public let pluginMethods: [CAPPluginMethod] = [
    ...
    CAPPluginMethod(name: "syncHistoricalData", returnType: CAPPluginReturnPromise),
    CAPPluginMethod(name: "syncStoreKit2Purchases", returnType: CAPPluginReturnPromise),
  ...
  @objc func syncStoreKit2Purchases(_ call: CAPPluginCall) {
